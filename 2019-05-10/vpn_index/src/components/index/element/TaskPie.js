      ...
      <div style={{ display: "flex" }}>
        ...
        >
          <div style={{ display: "flex", flex: '1', flexDirection: 'column' }}>
            <div style={{ fontSize: "1rem", color: "#62B1FF" }}>{`等待中数：`}</div>
            <div style={{ fontSize: "1rem", color: "#3ECACB" }}>{`进行中数：`}</div>
            <div style={{ fontSize: "1rem", color: "#51CB73" }}>{`已完成数：`}</div>
            <Tooltip placement="bottom" title="被手工暂停或实质已出结果">
              <div style={{ fontSize: "1rem", color: "#F2C41D" }}>{`暂停中数：`}</div>
            </Tooltip>
          </div>
          <div style={{ display: "flex", flex: '1', flexDirection: 'column', marginLeft: '-5rem' }}>
