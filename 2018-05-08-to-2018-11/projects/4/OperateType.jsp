...
<body style="margin: 0 !important; overflow: hidden; padding-bottom: 25px">
	...
	<form id="form_adv">
		...
		<div class="search_area search_adv" id="search_adv_div">
			...
			<div class="adv-select-label">中文描述：</div>
			<input type="text" class="span3" name="name" placeholder="中文描述">
	...
	<input type="hidden" id="operateTypeId" />
	<div id="operateType-grid"></div>
	<script type="text/javascript" src="/js/jsp/dba/operatetype/operateType.js"></script>
</body>
</html>